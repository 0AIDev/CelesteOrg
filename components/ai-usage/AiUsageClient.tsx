...
const PROVIDER_LOGO: Record<string, (props: { className?: string }) => React.ReactNode> = {
  ...
  anthropic: ({ className }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-label="Anthropic">
      <path d="M13.827.3C9.6.3 5.4 3.7 4.5 8.4c-.4 2.4.3 4.9 2.1 6.7l2.5 2.5c.6.6 1.5.5 1.9-.2.6-1.1 1.9-1.8 3.3-1.8 2 0 3.6 1.6 3.6 3.6s-1.6 3.6-3.6 3.6c-1.3 0-2.5-.7-3.2-1.8-.4-.7-1.3-.8-1.9-.2l-2.5 2.5c-1.8 1.8-4.5 1.5-6.1-.3-1-1.1-1.5-2.6-1.4-4 .1-1.7.8-3.3 2.1-4.5L1.7 13.7c-.5-.5-.5-1.4 0-1.9l2.5-2.5C3 7.7 2.5 5.9 2.9 4.1 3.9.9 7.3-1.3 10.7-.2c1.9.6 3.4 1.9 4.3 3.5.8-1 2-1.8 3.4-2.1 1.6-.3 3.3.1 4.6 1.2.5.5.6 1.3.1 1.9l-2.5 2.5c.7.7 1.2 1.7 1.3 2.7.2 1.4-.2 2.9-1.2 4-.6.7-1.5 1.1-2.4 1.1h-5.1c-.8 0-1.4.6-1.4 1.4s.6 1.4 1.4 1.4h3.2c.8 0 1.4.6 1.4 1.4s-.6 1.4-1.4 1.4h-5.1c-.8 0-1.4.6-1.4 1.4s.6 1.4 1.4 1.4h3.2c.8 0 1.4.6 1.4 1.4s-.6 1.4-1.4 1.4h-6.1c-.8 0-1.4-.6-1.4-1.4s.6-1.4 1.4-1.4h1.6v-1.4H4.7c-.8 0-1.4-.6-1.4-1.4s.6-1.4 1.4-1.4h6.1c.8 0 1.4-.6 1.4-1.4s-.6-1.4-1.4-1.4h-3.2c-.8 0-1.4-.6-1.4-1.4s.6-1.4 1.4-1.4h3.2c.8 0 1.4-.6 1.4-1.4s-.6-1.4-1.4-1.4h-1.6v-1.4c2.9.1 5.4 2.2 5.9 5.1.3 1.9-.3 3.8-1.6 5.3l.2.2c1.4 1.4 2.2 3.2 2.2 5.2s-.8 3.8-2.2 5.2c-1.2 1.2-2.8 2-4.5 2.1l.1.1h-5.1c-.8 0-1.4.6-1.4 1.4s.6 1.4 1.4 1.4h5.1c.8 0 1.4.6 1.4 1.4s-.6 1.4-1.4 1.4h-2.6c-.8 0-1.4.6-1.4 1.4s.6 1.4 1.4 1.4h2.6c2.4 0 4.4-1.9 4.4-4.3 0-1.2-.5-2.3-1.3-3.1l.1-.1c1.3-1.4 2.1-3.3 2.1-5.3s-.8-3.9-2.1-5.3l-.1-.1c-.6-.6-.6-1.5 0-2.1l.1-.1c.8.8 1.3 1.9 1.3 3.1 0 .8.6 1.4 1.4 1.4s1.4-.6 1.4-1.4c0-3.1-1.5-5.9-3.9-7.6z"/>
    </svg>
  ),
  google: ({ className }) => (
  ...
  groq: ({ className }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-label="Groq">
      <path d="M12 1.5 22.5 12 12 22.5 1.5 12 12 1.5Zm0 4.5L6 12l6 6 6-6-6-6Zm0 3 3 3-3 3-3-3 3-3Z"/>
    </svg>
  ),
  mistral: ({ className }) => (
...
// Brand-tinted bars for the cost-by-provider chart.
...
function providerBarColor(p: string): string {
  return PROVIDER_BAR_COLOR[p] ?? "#6b7280";
}
